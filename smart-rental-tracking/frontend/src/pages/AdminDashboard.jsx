    ...
    <div className="min-h-screen bg-[#f6f5f3]">
      ...
      <div className="mx-auto flex max-w-7xl">
        ...
        <aside
          ...
          } fixed left-0 top-0 z-50 h-full w-72 max-w-[85vw] shrink-0 overflow-y-auto border-r border-stone-200 bg-white p-4 transition-transform duration-200 ease-in-out md:sticky md:top-16 md:z-10 md:h-[calc(100vh-4rem)] md:w-64 md:translate-x-0 md:p-3 md:shadow-none`}
        >
